...
<body>
@section('panel-title', 'Crear Grupo')
    ...
    <form method="POST" action="{{ route('grupos.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: 6 a 8 años" required>
            </div>
            ...
            <div class="form-group full-width">
                ...
                <textarea name="descripcion" placeholder="Describe el grupo...">{{ old('descripcion') }}</textarea>
            </div>
